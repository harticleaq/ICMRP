...
from icmrp.utils.envs_tools import check, get_shape_from_obs_space
from icmrp.utils.models_tools import init, get_active_func, get_init_method
from icmrp.models.base.distributions import Categorical
...
class Actor(nn.Module):
    ...
    # get group embedding
    def get_group_embedding(self, obs, k, v):
        obs = check(obs).to(**self.tpdv)
        agent_embedding = self.group_embedding(obs, k, v)
