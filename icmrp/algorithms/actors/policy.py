"""actor algorithm."""
import torch
from icmrp.models.policy_models.squashed_gaussian_policy import SquashedGaussianPolicy
from icmrp.models.policy_models.stochastic_mlp_policy import StochasticMlpPolicy
from icmrp.utils.discrete_util import gumbel_softmax
from icmrp.utils.envs_tools import check
from icmrp.algorithms.actors.off_policy_base import OffPolicyBase


class Policy(OffPolicyBase):
    ...
    def get_actions(self, obs, available_actions=None, stochastic=True, msgs=None):
        ...
        if self.action_type == "Box":
            ...
            actions, msg = self.actor(obs, available_actions, stochastic, messages=msgs)
        return actions, msg

    def get_actions_with_logprobs(self, obs, available_actions=None, stochastic=True, messages=None):
        ...
        if self.action_type == "Box":
            ...
            logits = self.actor.get_logits(obs, available_actions, messages=messages)
